...
class UserDirectoryTestCase(unittest.HomeserverTestCase):
    ...
    def test_handle_local_profile_change_with_support_user(self) -> None:
        ...
        self.get_success(
            self.handler.handle_local_profile_change(
                support_user_id, ProfileInfo("I love support me", None, None)
            )
        )
        ...
        profile_info = ProfileInfo(avatar_url="avatar_url", display_name=display_name, user_type=None)
        self.get_success(
    ...
    def test_handle_local_profile_change_with_appservice_user(self) -> None:
        ...
        # update profile
        profile_info = ProfileInfo(avatar_url="avatar_url", display_name="4L1c3", user_type=None)
        self.get_success(
    ...
    def test_per_room_profile_doesnt_alter_directory_entry(self) -> None:
        ...
        self.assertEqual(
            users[alice], ProfileInfo(display_name="alice", avatar_url=None, user_type=None)
        )
    ...
    def test_ignore_display_names_with_null_codepoints(self) -> None:
        ...
        self.assertEqual(
            self.get_success(self.user_dir_helper.get_profiles_in_user_directory()),
            {alice: ProfileInfo(display_name=None, avatar_url=MXC_DUMMY, user_type=None)},
        )
...
class UserDirectoryRemoteProfileTestCase(unittest.HomeserverTestCase):
    ...
    def test_public_rooms_have_profiles_collected(self) -> None:
        ...
        *every* single profile change over federation.)
        ...
        self.assertEqual(
            ...
            ProfileInfo(display_name="Bruce!", avatar_url="mxc://remote/123", user_type=None),
        )
    ...
    def test_private_rooms_have_profiles_requested(self) -> None:
        ...
        self.assertEqual(
            profiles.get("@bruce:remote"),
            ProfileInfo(
                display_name="Sir Bruce Bruceson", avatar_url="mxc://remote/789", user_type=None
            ),
        )
