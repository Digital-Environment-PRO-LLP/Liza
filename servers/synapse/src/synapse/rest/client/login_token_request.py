...
class LoginTokenRequestServlet(RestServlet):
    ...
    def __init__(self, hs: "HomeServer"):
        ...
        # Ratelimit: 1 запрос в секунду, burst 60.
        # Поднято с апстримного 1/60 sec, burst 1 — оригинальный лимит ронял
        # OIDC-флоу через auth-proxy (2 синхронных запроса на логин + ретраи клиента).
