...
class DownloadResource(RestServlet):
    ...
    def register(self, http_server: HttpServer) -> None:
        ...
        # RestServlet.register регистрирует только GET/PUT/POST/DELETE.
        # HEAD на download-эндпоинте нужен, чтобы клиент HEAD-пробой проверял
        # заголовок Accept-Ranges перед потоковым просмотром видео.
        # Переиспользуем on_GET — respond_with_responder для HEAD-запроса
        # отдаёт только заголовки, без тела.
