...
class LizaErrorWidget extends StatefulWidget {
  final FlutterErrorDetails details;
  const LizaErrorWidget(this.details, {super.key});

  @override
  State<LizaErrorWidget> createState() => _LizaErrorWidgetState();
}

class _LizaErrorWidgetState extends State<LizaErrorWidget> {
