...
import '../../utils/message_link.dart';
...
class PublicRoomDialog extends StatelessWidget {
  ...
  /// eventId из matrix.to-ссылки на сообщение: после входа в комнату
  /// открываем именно это событие, а не начало чата (LABA-2217).
  final String? navigateEventId;
  ...
  void _joinRoom(BuildContext context) async {
    ...
    if (chunk?.roomType != 'm.space' &&
      ...
      // Для ссылки на сообщение (navigateEventId задан) — скролл к событию;
      // eventId неприменим к пространству.
      context.go(roomEventPath(roomId, navigateEventId));
    } else {
    ...
    return AlertDialog.adaptive(
      ...
      actions: [
        AdaptiveDialogAction(
          ...
          child: Text(
            isCompany
                ? L10n.of(context).subscribeToCompany
