...
import 'package:liza/pages/chat_search/search_footer.dart';
...
import 'package:liza/utils/protected_selection.dart';
...
class ChatSearchFilesTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final contentProtected = room.isContentProtected;
    return protectedSelectionArea(
      selectable: !contentProtected,
              ...
              children: [
                ...
                Material(
                  ...
                  child: ListTile(
                    ...
                    // Тап по результату поиска = скачивание файла. В
                    // защищённом канале это тот же вынос контента, что и
                    // «Скачать» в меню сообщения — тап обезвреживаем.
                    onTap: contentProtected
                        ? null
