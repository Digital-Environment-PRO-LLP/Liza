...
class StartPollBottomSheet extends StatefulWidget {
  ...
  /// Опрос Liza News всегда не анонимный — тумблера видимости ответов нет.
  final bool alwaysDisclosed;

  const StartPollBottomSheet({
    required this.room,
    this.alwaysDisclosed = false,
    super.key,
  });
