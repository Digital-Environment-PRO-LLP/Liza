...
class PollWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (eventContent == null) {
      ...
      return Text(L10n.of(context).pollParseError);
    }
...
/// Текст вопроса опроса со ссылками: тап открывает, правый клик (desktop) /
/// долгое нажатие (mobile) — меню ссылки (LABA-1965, паритет с обычным текстом).
/// StatefulWidget ради пула распознавателей ссылок (dispose обязателен).
class _PollQuestion extends StatefulWidget {
  final String text;
  final Color textColor;
  final Color linkColor;
  ...
  @override
  State<_PollQuestion> createState() => _PollQuestionState();
}

class _PollQuestionState extends State<_PollQuestion> {
