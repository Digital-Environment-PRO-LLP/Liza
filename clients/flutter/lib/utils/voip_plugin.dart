...
import 'package:liza/pages/dialer/dialer.dart';
...
class VoipPlugin
    ...
    implements WebRTCDelegate, VoipHandle {
  ...
  /// Реализация [VoipHandle]: вызывающим из основного чанка (`pages/chat`)
  /// не нужен доступ к самому `voip` — иначе тип `VoIP` утёк бы в сигнатуру
  /// и вернул webrtc-стек обратно в главный чанк.
  @override
  Future<void> inviteToCall(Room room, CallType callType) =>
      voip.inviteToCall(room, callType);
